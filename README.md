...
2. Прописать pod install в терминале и дождаться загрузки 
3. Откройте проект в Xcode и дождитесь загрузки Snapshot-testing
4. Запустите симулятор или подключите устройство и выберите его в качестве целевого устройства
